...
$a_length = floor($total_length / 100);
...
fann_save_train ($training_data_a, 'MyTrainingData_Subset_A.data'); // 1/100 of the training data
fann_save_train ($training_data_b, 'MyTrainingData_Subset_B.data'); // 99/100 of the training data
